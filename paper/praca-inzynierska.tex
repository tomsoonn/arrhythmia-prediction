...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{manager_code.jpg}
	\caption{Kod klasy managera widoków}
	\label{fig:manager_code}
\end{figure}

<<diagram klas modu³u interface???>>
<<przyk³adowy plik .ui???>>
<<wygl±d qt Designer???>>
...
Kod wraz z dokumentacj± trzymali¶my w repozytorium \textbf{Git} na platformie \textbf{GitHub}.
