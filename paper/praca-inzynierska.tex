...
W odrêbnym module znajduj± siê wszystkie testy.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_10_50_10_loss.png}
	\caption{Funkcja straty dla sieci gêstej o rozmiarach warstw 10, 50, 10}
	\label{fig:simple_10_50_10_loss}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_10_50_10_acc.png}
	\caption{Funkcja dok³adno¶ci dla sieci gêstej o rozmiarach warstw 10, 50, 10}
	\label{fig:simple_10_50_10_acc}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_100_100_loss.png}
	\caption{Funkcja straty dla sieci gêstej o rozmiarach warstw 100,100}
	\label{fig:simple_100_100_loss}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_100_100_acc.png}
	\caption{Funkcja dok³adno¶ci dla sieci gêstej o rozmiarach warstw 100,100}
	\label{fig:simple_100_100_acc}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_100_200_100_loss.png}
	\caption{Funkcja straty dla sieci gêstej o rozmiarach warstw 100,200,100}
	\label{fig:simple_100_200_100_loss}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{simple_100_200_100_acc.png}
	\caption{Funkcja dok³adno¶ci dla sieci gêstej o rozmiarach warstw 100,200,100}
	\label{fig:simple_100_200_100_acc}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Funkcja straty dla sieci konwolucyjnej z parametrami: pool=16, warstwy=[(4, 16), (16, 16)]}
...
\begin{figure}[H]
	...
	\caption{Funkcja dok³adno¶ci dla sieci konwolucyjnej z parametrami: pool=16, warstwy=[(4, 16), (16, 16)]}
...
\begin{figure}[H]
	...
	\caption{Funkcja straty dla sieci konwolucyjnej z parametrami: pool=16, warstwy=[(32, 16), (16, 16)]}
...
\begin{figure}[H]
	...
	\caption{Funkcja dok³adno¶ci dla sieci konwolucyjnej z parametrami: pool=16, warstwy=[(32, 16), (16, 16)]}
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=0.7\linewidth]{conv_16_16_loss.png}
	\caption{Funkcja straty dla sieci konwolucyjnej z parametrami: pool=16, warstwy=[(16, 16), (8, 16), (4, 16)]}
	\label{fig:conv_16_16_loss}
\end{figure}
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering}
	\includegraphics[width=0.7\linewidth]{conv_16_16_acc.png}
	\caption{Funkcja dok³adno¶ci dla sieci konwolucyjnej z parametrami: pool=16, warstwy[(16, 16), (8, 16), (4, 16)]}
	\label{fig:conv_16_16_acc}
\end{figure}
